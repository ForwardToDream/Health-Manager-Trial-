...
from core.reminder_logic import should_trigger_reminder, get_half_hour_period_id
from core import event_bus
from ui.utils.time_utils import get_timezone_str, get_current_time_str
...
class ReminderCard(ft.Container):
    ...
    def _init_components(self):
        self.countdown_text = ft.Text(
            value="--:--", size=48, weight=ft.FontWeight.BOLD, 
        ...
        self.warning_text = I18nText(
            key="reminder_warning", color=ft.Colors.WHITE, 
        ...
        self.warning_container = ft.Container(
            ...
            bgcolor=ft.Colors.RED_500, padding=10, border_radius=8,
    ...
    def _build_content(self):
        return ft.Column([
            ft.Row([
                ft.Icon(ft.Icons.ACCESS_ALARM, color=ft.Colors.ORANGE_500),
                I18nText(key="reminder_title", size=18, weight=ft.FontWeight.W_600)
            ]),
        ...
        try:
            if self.page:
                self.page.snack_bar = ft.SnackBar(
                    content=ft.Text(
                        i18n_manager.t("reminder_warning"), 
